        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link active rounded" id="activenav" aria-current="page" href="index.php">Home</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdownlist">
                            <a class="dropdown-item rounded dropdownnav" href="login/login.php">Diet Plan</a>
                            <a class="dropdown-item rounded dropdownnav" href="login/login.php">Workout Plan</a>
                            <a class="dropdown-item rounded dropdownnav" href="login/login.php">Add a Trainer</a>
                        </div>
                    </li>
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <div class="d-flex align-items-center  " id="bgdesc">
                                    ...
                                    <!-- <div type="button" id="bgbtn" class=" "> -->
                                    <a class="btn btn-primary btnlink" href="index.php#features">Our services</a>
                                    <!-- </div> -->
                                </div>
                        ...
                        <div class="card-box align-left">
                            ...
                            <div class="link-wrap">
                                <h6 class="link align-left "><a class="text-success text-primary readmore"
                                        href="login/login.php">&nbsp;Read more &gt;</a>
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-wrapper mb-3">
                        <div class="card-box align-left">
                            ...
                            <p class=" mb-3 firstpara">
                                ...
                                steps
                                they'll need to take to reach their desired destination.
                    ...
                    <div class="row">
                        <div class="col-12">
                            <ul class="list-unstyled pb-4">
                                ...
                                <li><a href="login/login.php">Services</a></li>
