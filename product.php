        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link active rounded" aria-current="page" href="index.php">Home</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link rounded" href="product.php" id="activenav">Products </a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="card-box">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="button rounded"><a href="login/login.php"
