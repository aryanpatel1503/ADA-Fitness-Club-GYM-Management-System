...
<body>
    ...
    <section class="" id="dietsecondsection">
        ...
        $query = "SELECT * FROM plan_tbl WHERE plan_type='Diet' order by plan_id asc";
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <form action="feedback.php" method="post">
                        ...
                        <fieldset class="form-group">
                            <textarea class="form-control" id="exampleMessage" name="feedback" placeholder="Enter Your Feedback" required></textarea>
                        </fieldset>
